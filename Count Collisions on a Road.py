...
- Cars 4 and 5 will collide with each other. After car 4 collides with car 3, it will stay at the point of collision and get hit by car 5. The number of collisions
becomes 4 + 1 = 5.
        ...
        for i in range(length):
            if stack==[]:
                ...
                if stack[-1]=='R' and s[i]=='L':
                    ...
                    stack.extend(['S','S'])
                    count=0
                elif stack[-1]=='S' and s[i]=='L':
                    collisions+=1
                    stack.append('S')
                    count=0
                elif stack[-1]=='R' and s[i]=='S':
                    collisions+=1
                    if count>1:
                        collisions+=(count-1)
                    stack.pop()
